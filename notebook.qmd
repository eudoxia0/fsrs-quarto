...
$$
\alpha = 1 + t_1 t_2 t_3 t_4 t_5 t_6
$$
...
If recall was easy, it has no effect ($t_4=1$). If recall was hard, we apply $w_{15}$ (a learned parameter between 0 and 1). This penalizes stability growth where recall was shaky.

TODO: check the actual conditions of $G$

### $t_5$

This is the opposite of the previous term, a bonus for easy recall:
...
If recall was hard or good, there is no bonus. If recall was easy, we multiply by $w_{16}$, a number greater than one, which scales up.

TODO verify actual conditions of $G$
